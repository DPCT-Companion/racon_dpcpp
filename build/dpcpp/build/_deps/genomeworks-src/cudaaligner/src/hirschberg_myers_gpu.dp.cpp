                                    ...
                                    sycl::nd_item<3> item_ct1)
{
    ...
    /*
    DPCT1023:105: The DPC++ sub-group does not support mask options for
                              ...
                              sycl::nd_item<3> item_ct1)
{
    ...
    {
        /*
        DPCT1023:106: The DPC++ sub-group does not support mask options for
        sycl::shift_group_right.
        */
        uint32_t x =
    ...
    for (int32_t t = 1; t <= target_size; ++t)
    {
             ...
             idx += warp_size)
        {
            if (idx < n_words)
            {
                ...
                {
                    /*
                    DPCT1023:107: The DPC++ sub-group does not support mask
...
#pragma unroll
    ...
    {
        /*
        DPCT1023:109: The DPC++ sub-group does not support mask options for
        sycl::shift_group_left.
        */
        const int32_t mv =
            sycl::shift_group_left(item_ct1.get_sub_group(), cur_min, i);
        /*
        DPCT1023:110: The DPC++ sub-group does not support mask options for
        sycl::shift_group_left.
        */
        const int32_t mp =
            sycl::shift_group_left(item_ct1.get_sub_group(), midpoint, i);
        if (mv < cur_min)
        {
            cur_min  = mv;
            midpoint = mp;
    ...
    /*
    DPCT1023:108: The DPC++ sub-group does not support mask options for
    sycl::select_from_group.
    */
    sycl::select_from_group(item_ct1.get_sub_group(), midpoint, 0);
