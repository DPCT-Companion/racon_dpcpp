...
{
public:
    AlignerGlobal(int32_t max_query_length, int32_t max_target_length,
...
private:
    virtual void run_alignment(int8_t *results_d, int32_t *result_lengths,
                               int32_t max_result_length,
                               const char *sequences_d,
                               int32_t *sequence_lengths_d,
                               int32_t *sequence_lengths_h,
                               int32_t max_sequence_length,
                               int32_t num_alignments, sycl::queue *stream) = 0;
