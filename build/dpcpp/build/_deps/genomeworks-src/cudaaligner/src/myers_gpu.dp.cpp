                                    ...
                                    sycl::nd_item<3> item_ct1)
{
    ...
    /*
    DPCT1023:153: The DPC++ sub-group does not support mask options for
                                     ...
                                     sycl::nd_item<3> item_ct1)
{
    ...
    /*
    DPCT1023:154: The DPC++ sub-group does not support mask options for
                              ...
                              sycl::nd_item<3> item_ct1)
{
    ...
    {
        /*
        DPCT1023:155: The DPC++ sub-group does not support mask options for
        sycl::shift_group_right.
        */
        uint32_t x =
             ...
             idx += warp_size)
        {
            if (idx < n_words)
            {
                ...
                if (warp_mask == 0xffff'ffffu &&
                    ...
                    /*
                    DPCT1023:156: The DPC++ sub-group does not support mask
            ...
            if (idx < n_words)
            {
                ...
                if (warp_mask == 0xffff'ffffu &&
                    (item_ct1.get_local_id(2) == 0 ||
                     item_ct1.get_local_id(2) == 31))
                    /*
                    DPCT1023:157: The DPC++ sub-group does not support mask
                    options for sycl::shift_group_left.
                    */
                    warp_carry = sycl::shift_group_left(
                        item_ct1.get_sub_group(), warp_carry, warp_size - 1);
            ...
            if (idx < n_words_band)
            {
                ...
                if (warp_mask == 0xffff'ffffu &&
                    (item_ct1.get_local_id(2) == 0 ||
                     item_ct1.get_local_id(2) == 31))
                    /*
                    DPCT1023:158: The DPC++ sub-group does not support mask
                    options for sycl::shift_group_left.
                    */
                    carry =
...
int32_t myers_compute_edit_distance(std::string const& target, std::string const& query)
{
    ...
    sycl::queue *stream;
    /*
    DPCT1003:159: Migrated API does not return error code. (*, 0) is inserted.
    ...
    */
    GW_CU_CHECK_ERR((stream = dpct::get_current_device().create_queue(), 0));
    {
        ...
        */
        GW_CU_CHECK_ERR((stream->memcpy(sequences_d.data(), query.data(),
                         ...
                         0));
        /*
        DPCT1003:161: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
    ...
    /*
    DPCT1003:164: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
...
matrix<int32_t> myers_get_full_score_matrix(std::string const& target, std::string const& query)
{
    ...
    sycl::queue *stream;
    /*
    DPCT1003:165: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
    GW_CU_CHECK_ERR((stream = dpct::get_current_device().create_queue(), 0));

    {
        ...
        */
        GW_CU_CHECK_ERR((stream->memcpy(sequences_d.data(), query.data(),
                         ...
                         0));
        /*
        DPCT1003:167: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
            (stream->memcpy(sequences_d.data() + max_sequence_length,
             ...
             0));
        /*
        DPCT1003:168: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR((stream->memcpy(sequence_lengths_d.data(),
                                        lengths.data(), sizeof(int32_t) * 2),
