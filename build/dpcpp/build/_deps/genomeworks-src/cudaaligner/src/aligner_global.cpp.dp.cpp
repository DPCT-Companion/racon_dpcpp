      ...
      result_lengths_h_(max_alignments), stream_(stream), device_id_(device_id)
{
    ...
    */
    GW_CU_CHECK_ERR((stream->memset(sequences_d_.data(), 0,
                                    sizeof(char) * sequences_d_.size()),
                     0));
    /*
    DPCT1003:114: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
    GW_CU_CHECK_ERR((stream->memset(sequence_lengths_d_.data(), 0,
                                    sizeof(char) * sequence_lengths_d_.size()),
                     0));
    /*
    ...
    */
    ...
    You may need to rewrite this code.
    */
    GW_CU_CHECK_ERR((stream->memset(result_lengths_d_.data(), 0,
                                    sizeof(char) * result_lengths_d_.size()),
                     0));
}
...
StatusType AlignerGlobal::align_all()
{
    ...
    */
    GW_CU_CHECK_ERR(
        (stream_->memcpy(sequence_lengths_d_.data(), sequence_lengths_h_.data(),
    ...
    You may need to rewrite this code.
    */
    GW_CU_CHECK_ERR((stream_->memcpy(sequences_d_.data(), sequences_h_.data(),
                                     2 * sizeof(char) * max_alignment_length *
                                         num_alignments),
                     0));
    ...
    */
    GW_CU_CHECK_ERR(
        (stream_->memcpy(results_h_.data(), results_d_.data(),
    ...
    */
    GW_CU_CHECK_ERR(
        (stream_->memcpy(result_lengths_h_.data(), result_lengths_d_.data(),
