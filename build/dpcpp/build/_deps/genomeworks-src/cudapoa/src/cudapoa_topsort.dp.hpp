...
void topologicalSortDeviceUtil(SizeT* sorted_poa,
...
template <typename SizeT>
void raconTopologicalSortDeviceUtil(SizeT* sorted_poa,
                                               SizeT* sorted_poa_node_map,
                                               SizeT node_count,
                                               uint16_t* incoming_edge_count,
...
template <typename SizeT>
void runTopSortKernel(SizeT* sorted_poa,
                                 SizeT* sorted_poa_node_map,
                                 SizeT node_count,
                                 uint16_t* incoming_edge_count,
                                 SizeT* outgoing_edges,
                ...
                uint16_t* local_incoming_edge_count)
{
    ...
    dpct::get_default_queue().parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            runTopSortKernel(sorted_poa, sorted_poa_node_map, node_count,
                             incoming_edge_count, outgoing_edges,
                             outgoing_edge_count, local_incoming_edge_count);
        });
    /*
