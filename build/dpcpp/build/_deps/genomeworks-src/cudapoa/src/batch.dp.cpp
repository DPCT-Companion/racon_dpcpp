...
std::unique_ptr<Batch> create_batch(int32_t device_id, sycl::queue *stream,
                                    size_t max_mem, int8_t output_mask,
                                    const BatchConfig &batch_size,
                                    int16_t gap_score, int16_t mismatch_score,
                                    int16_t match_score)
{
