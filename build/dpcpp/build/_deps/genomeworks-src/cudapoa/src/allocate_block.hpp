...
public:
        ...
        , output_mask_(output_mask)
    {
        ...
        */
        /*
        DPCT1048:26: The original value cudaHostAllocDefault is not meaningful
        in the migrated code and was removed or replaced with 0. You may need to
        check the migrated code.
        */
        GW_CU_CHECK_ERR((block_data_h_ = (uint8_t *)sycl::malloc_host(
                             total_h_, dpct::get_default_queue()),
                         0));
        /*
        DPCT1003:66: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR((block_data_d_ = (uint8_t *)sycl::malloc_device(
                             total_d_, dpct::get_default_queue()),
                         0));
    }
    ...
    ~BatchBlock()
    {
        ...
        */
        GW_CU_CHECK_ERR(
            (sycl::free(block_data_d_, dpct::get_default_queue()), 0));
        /*
        DPCT1003:68: Migrated API does not return error code. (*, 0) is
        inserted. You may need to rewrite this code.
        */
        GW_CU_CHECK_ERR(
            (sycl::free(block_data_h_, dpct::get_default_queue()), 0));
    }
