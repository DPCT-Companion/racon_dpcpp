...
public:
    ...
    pointer allocate(std::size_t n,
                     const std::vector<sycl::queue *> &streams = {{0}}) try {
        ...
        */
        int err = (ptr = (void *)sycl::malloc_device(n * sizeof(T),
                                                     dpct::get_default_queue()),
                   0);
        /*
        DPCT1002:17: Special case error handling if-stmt was detected. You may
    ...
    void deallocate(pointer p, std::size_t n)
    {
        ...
        */
        ...
        inserted. You may need to rewrite this code.
        */
        GW_CU_ABORT_ON_ERR((sycl::free(p, dpct::get_default_queue()), 0));
    }
...
public:
    ...
    pointer allocate(std::size_t n,
        ...
        void* ptr       = nullptr;
        int err =
            memory_resource_->DeviceAllocate(&ptr, n * sizeof(T), streams);
        /*
        DPCT1002:22: Special case error handling if-stmt was detected. You may
        need to rewrite this code.
        */
        if (err == 2)
        {
