        ...
        , cudaaligner_band_width_(cudaaligner_band_width)
{
    ...
    for(int32_t dev_id = 0; dev_id < num_devices_; dev_id++)
    {
        ...
        /*
        DPCT1003:175: Migrated API does not return error code. (*, 0) is
...
CUDAPolisher::~CUDAPolisher()
{
    ...
    /*
    DPCT1007:177: Migration of this CUDA API is not supported by the Intel(R)
    ...
    if (cudaaligner_batches_ >= 1)
    {
        ...
        for(int32_t device = 0; device < num_devices_; device++)
        {
            ...
            */
            ...
            size_t free, total;
            /*
            DPCT1003:179: Migrated API does not return error code. (*, 0) is
            inserted. You may need to rewrite this code.
            */
            /*
    ...
    bool drop_unpolished_sequences)
{
    ...
    else
    {
        ...
        for(int32_t device = 0; device < num_devices_; device++)
        {
            ...
            /*
            DPCT1003:181: Migrated API does not return error code. (*, 0) is
            inserted. You may need to rewrite this code.
            */
            GW_CU_CHECK_ERR(
                (dpct::dev_mgr::instance().select_device(device), 0));
            /*
            DPCT1003:182: Migrated API does not return error code. (*, 0) is
            inserted. You may need to rewrite this code.
            */
            /*
