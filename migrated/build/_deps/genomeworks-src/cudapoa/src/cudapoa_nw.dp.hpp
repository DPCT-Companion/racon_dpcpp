             ...
             ScoreT gap_score, ScoreT match_score, ScoreT mismatch_score)
{
    ...
    score.s0 = sycl::max((ScoreT)(score4.s0 + char_profile.s0),
                         (ScoreT)(score4.s1 + gap_score));
    score.s1 = sycl::max((ScoreT)(score4.s1 + char_profile.s1),
                         (ScoreT)(score4.s2 + gap_score));
    score.s2 = sycl::max((ScoreT)(score4.s2 + char_profile.s2),
                         (ScoreT)(score4.s3 + gap_score));
    score.s3 = sycl::max((ScoreT)(score4.s3 + char_profile.s3),
                         (ScoreT)(score4_next.s0 + gap_score));
    ...
    for (SizeT p = 1; p < pred_count; p++)
    {
        ...
        score.s0 = sycl::max((ScoreT)(score4.s0 + char_profile.s0),
                             sycl::max(score.s0, (ScoreT)(score4.s1 + gap_score)));

        score.s1 = sycl::max((ScoreT)(score4.s1 + char_profile.s1),
                             sycl::max(score.s1, (ScoreT)(score4.s2 + gap_score)));

        score.s2 = sycl::max((ScoreT)(score4.s2 + char_profile.s2),
                             sycl::max(score.s2, (ScoreT)(score4.s3 + gap_score)));

        score.s3 =
            sycl::max((ScoreT)(score4.s3 + char_profile.s3),
                      sycl::max(score.s3, (ScoreT)(score4_next.s0 + gap_score)));
    }
