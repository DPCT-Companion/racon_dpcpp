                  ...
                  uint32_t max_limit_nodes_per_window)
{
    dpct::get_default_queue().parallel_for(
        ...
        [=](sycl::nd_item<3> item_ct1) {
            addAlignmentKernel<SizeT>(
                nodes, node_count, node_alignments, node_alignment_count,
                incoming_edges, incoming_edge_count, outgoing_edges,
                outgoing_edge_count, incoming_edge_w, outgoing_edge_w,
                alignment_length, graph, alignment_graph, read, alignment_read,
                node_coverage_counts, base_weights, sequence_begin_nodes_ids,
                outgoing_edges_coverage, outgoing_edges_coverage_count, s,
                max_sequences_per_poa, max_limit_nodes_per_window);
        });
}
