...
std::unique_ptr<Aligner> create_aligner(int32_t max_query_length,
...
create_aligner(int32_t max_query_length, int32_t max_target_length,
               int32_t max_alignments, AlignmentType type, sycl::queue *stream,
               int32_t device_id,
               int64_t max_device_memory_allocator_caching_size)
{
...
std::unique_ptr<Aligner> create_aligner(const AlignmentType type,
